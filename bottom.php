		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/moviestar/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://premiumfreewordpressthemes.com/category/cinema/' target='_blank'>Free Wordpress Movie Themes</a>, thanks to: <a href='http://favorwish.com/' target='_blank'>Nintendo Wii U</a>, <a href='http://smnnews.com' target='_blank'>Sins Metal News</a> and <a href='http://topshowsontv.com/' target='_blank'>Top Shows on TV</a></div>
			</div>
			</div>
		<?php wp_footer(); ?>
