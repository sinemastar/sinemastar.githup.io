    ...
    $settings = array(
		...
		'layout'=>array(
			...
			'content'=>array(
				...
				'cuttxt'=>array(
					'type'=>'text','name'=>'cuttxt','value'=>'800','ttl'=>'Length of content in the feed', 'hint'=>'If value more then 0, post in the feed, without excerpt and "read more" tag, will be cutted to that number of chars.'
				),
				'imgwidth'=>array(
					'type'=>'text','name'=>'imgwidth','value'=>'293','ttl'=>'Loop image width', 'hint'=>'Featured images width (px)'
				)
				,
				'imgheight'=>array(
					'type'=>'text','name'=>'imgheight','value'=>'165','ttl'=>'Loop image height', 'hint'=>'Featured images height (px)'
				),
				'imgpos'=>array(
